...
console.log('      --(ㆆ_ㆆ)--');
console.log();
let nome = readline.question('Ola, Estranho! Qual seu nome?');
let vida = 10;
let ouro = 0;
let forca = 0;
let gameplay = true;
...
console.log();
console.log('      --(ㆆ_ㆆ)--\nOtimo, agora vamos escolher sua classe.');
console.log('---classes---');
console.log(' - cavaleiro\n - arqueiro\n - mago');
let classe = readline.question('selecione sua classe: ').toLowerCase();
      ...
      switch (evento) {
        case 0:
          ...
          if (re === 'sim') {
            ...
            console.log()
            console.log('====================');
            console.log('Conquista Alcancada!');
